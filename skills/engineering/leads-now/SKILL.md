...
```
Har vi appen uppe i produktion?
  Ja → Gå direkt till appen, scanna en stad, spara leads
  Nej → Kolla host-dashboarden / deploy-status
...
- Kontrollera att ANTHROPIC_API_KEY är satt i host-miljön
- Kolla server-loggarna efter `Overpass returned 0 elements`
