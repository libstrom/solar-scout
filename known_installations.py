# Enspecta Energi — befintliga solcellsinstallationer
#
# Dessa adresser ska ALDRIG visas som leads i solar-scout.
# Källa: Enspectas installationshistorik, importerad 2026-05-19.
#
# Format: (lat, lng, adress)
# Koordinater geocodade via Nominatim/OSM.
#
# Saknar koordinater (behöver manuell uppslag):
#   - Nefirsgatan 12, Staffanstorp
#   - Borgmästaregården 19, Kristianstad

ENSPECTA_INSTALLATIONS: list[tuple[float, float, str]] = [
